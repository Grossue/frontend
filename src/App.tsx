...
import NewsMemoryLoadingPage from "./pages/NewsMemoryLoading";
      ...
      <BrowserRouter>
        <div className="App">
          <Routes>
            ...
            <Route
              path="/newsmemory1/general/:year/:month/:date/:id"
              element={<NewsMemory1GeneralPage />}
            />
            <Route
              path="/newsmemory1/script/:year/:month/:date/:id"
              element={<NewsMemory1ScriptPage />}
            />
            <Route
              path="/newsmemory2/:year/:month/:date/:id"
              element={<NewsMemory2Page />}
            />
            <Route
              path="/newsmemory/loading"
              element={<NewsMemoryLoadingPage />}
            />
          </Routes>
          <Sidebar />
        </div>
